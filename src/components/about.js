                ...
                <Row className="about-section">
                    ...
                    <Col lg={7}>
                        <div className="col-12 col-md-12 col-lg-8 m-auto mt-5">
                            ...
                            <Button variant="dark" href='https://drive.google.com/file/d/17Alh8wPjFEAynVXwmhDgiRBL-BK8DFrP/view?usp=drive_link' target='blank' className="mt-3">View My Resume</Button>
                        </div>
                    </Col>
                </Row>
            </Container>
